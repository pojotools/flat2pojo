...
# flat2pojo Release Publishing Script
...
echo -e "${BLUE}===== flat2pojo Release Publisher =====${NC}"
...
if [[ ! -f "pom.xml" ]] || ! grep -q "flat2pojo-parent" pom.xml; then
    echo -e "${RED}Error: Not in flat2pojo project root directory${NC}"
