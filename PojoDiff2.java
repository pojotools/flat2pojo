...
public final class PojoDiff {
    ...
    private static void buildHints(String basePtr, JavaType jt, TypeHints hints,
        ...
        if (jt == null) return;
        jt = unwrapOptionals(jt, mapper); // unwrap Optional<T> & Optional primitives
        ...
        // Jackson bean properties (works for classes/builders)
        ...
        // Fallback for immutable interfaces (Immutables-style)
    ...
    private static JavaType unwrapOptionals(JavaType type, ObjectMapper mapper) {
        ...
        // Jackson ReferenceType (e.g., Optional<T>)
